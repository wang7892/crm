export default {
  ...
  'module.order': 'Processing Order',
  'module.order.stateFlow': 'Processing Order Status Flow',
  'module.order.state': 'Processing Order Status',
  'module.order.stateType': 'Status Type',
  'module.order.stateFlowSet': 'Processing Order Status Flow Settings',
  'module.order.stateConfig': 'Order Status Config',
  'module.order.stateBackConfig': 'Status rollback config',
  'module.order.stageHasData': 'There is data in the current processing order status, forbidden to delete!',
