export default {
  ...
  'customer.wecomMonitor.title': 'WeCom monitoring & follow-up sync',
  'customer.wecomMonitor.sessionList': 'Chats',
  'customer.wecomMonitor.messages': 'Messages',
  'customer.wecomMonitor.matchPanel': 'CRM matching',
  'customer.wecomMonitor.wecomExternal': 'WeCom external contact',
  'customer.wecomMonitor.matchedCustomer': 'Matched CRM account',
  'customer.wecomMonitor.wecomStaff': 'WeCom internal user',
  'customer.wecomMonitor.matchedStaff': 'Matched CRM owner',
  'customer.wecomMonitor.matchRule': 'Matching rule',
  'customer.wecomMonitor.overrideCustomer': 'Override account',
  'customer.wecomMonitor.overrideOwner': 'Override owner',
  'customer.wecomMonitor.followType': 'Follow-up type',
  'customer.wecomMonitor.followTypeCustomer': 'Account',
  'customer.wecomMonitor.selectedSummary': 'Selected messages',
  'customer.wecomMonitor.sync': 'Sync to CRM follow-up',
  'customer.wecomMonitor.emptySessions':
    'No buffered sessions. Ensure the monitor service writes wecom_ingestion_event.',
  'customer.wecomMonitor.selectSession': 'Select a chat on the left',
  'customer.wecomMonitor.selectMessages': 'Select at least one message',
  'customer.wecomMonitor.syncSuccess': 'Follow-up record created',
  'customer.wecomMonitor.directionInbound': 'Inbound',
  'customer.wecomMonitor.directionOutbound': 'Outbound',
  'customer.wecomMonitor.syncedTag': 'Synced',
  'customer.wecomMonitor.deleteSessionConfirm':
    'Delete this conversation and its monitored messages? Existing CRM follow-up records will be kept.',
  'customer.wecomMonitor.deleteSessionSuccess': 'Conversation deleted',
  'customer.wecomMonitor.deleteConfirm': 'Delete',
  'customer.wecomMonitor.deleteCancel': 'Cancel',
  'customer.wecomMonitor.roomChat': 'Room',
  'customer.wecomMonitor.loading': 'Loading...',
  'customerFollow.index': 'No.',
  'customerFollow.specialist': 'Contact Specialist',
  'customerFollow.followedCustomer': 'Followed Accounts',
  'customerFollow.customerCount': 'Accounts',
  'customerFollow.recordCount': 'Follow-ups',
  'customerFollow.latestFollowTime': 'Latest Follow-up',
  'customerFollow.viewCustomer': 'View Accounts',
  'customerFollow.companyCustomer': 'Company Accounts',
  'customerFollow.exhibitionCustomer': 'Exhibition Accounts',
  'customerFollow.backToSpecialist': 'Back to Specialists',
};
